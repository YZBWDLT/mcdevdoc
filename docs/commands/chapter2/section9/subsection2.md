...
![camera_fade_1](../img/section9/camera_fade_1.png)
...
![camera_fade_2](../img/section9/camera_fade_2.png)
...
- `/camera @s set minecraft:free pos 5 -30 5 facing 5 -60 5`：从(5,-30,5)面向(5,-60,5)的相机视角。  
  ![camera_set_1](../img/section9/camera_set_1.png)
- `/camera @s set minecraft:free pos ^-2^2^-4 facing ^^^5`：这是 Wiki 给出的示例，实现越肩视角！
  ![camera_set_2](../img/section9/camera_set_2.png)
...
![easing_function_1](../img/section9/easing_function_1.png)
...
![camera_set_3](../img/section9/camera_set_3.png)
...
![camera_set_4](../img/section9/camera_set_4.png)
