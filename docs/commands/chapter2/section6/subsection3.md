...
![inputpermission_1](../img/section6/inputpermission_1.png)
...
![inputpermission_2](../img/section6/inputpermission_2.png)
...
`/gamemode`我们曾在 [2.2](../section2) 时详细地讲过，相信现在已经无需多言。我们直接进行语法回顾，然后迅速跳过这一部分。看，虽然 2.2 讲的命令比较简单，但是要掌握的东西还是很多的！
...
| `l=<最小经验等级: int>` | **M**inimum **L**evel | 检查经验等级大于等于`最小经验等级`的玩家 | 玩家数据 | |
