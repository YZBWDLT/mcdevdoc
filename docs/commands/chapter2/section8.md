...
![block_state_1](./img/section8/block_state_1.png)
...
![block_state_2](./img/section8/block_state_2.png)
...
![setblock_1](./img/section8/setblock_1.png)
...
![execute_if_block_1](./img/section8/execute_if_block_1.png)

然后，执行`/execute if block ~~~ stone_button ["facing_direction"=0]`，它的测试还通过吗？如果不通过，把 0 换成其它的状态，看看躺在地上的按钮的朝向应该是什么值？

:::

![execute_if_block_2](./img/section8/execute_if_block_2.png)
...
![fill_1](./img/section8/fill_1.png)
...
![fill_2](./img/section8/fill_2.png)
