...
![comparator_1](./img/section1/comparator_1.png)

红石比较器有两种模式，**比较模式和减法模式**，两种模式依靠手动切换。比较模式下输出端的红石火把是熄灭状态，而减法模式则是亮起状态。

![comparator_2](./img/section1/comparator_2.png)
...
![comparator_3](./img/section1/comparator_3.png)  
上图中，主输入 I=14，副输入 C=13，因为 I>C，所以输出信号为 14。

![comparator_4](./img/section1/comparator_4.png)  
...
![comparator_5](./img/section1/comparator_5.png)  
...
![comparator_6](./img/section1/comparator_6.png)  
上图中，主输入 I=14，副输入 C=13，所以输出信号为 14-13=1。

![comparator_7](./img/section1/comparator_7.png)  
...
![comparator_8](./img/section1/comparator_8.png)  
...
![copper_bulb](./img/section1/copper_bulb.png)  
...
![rail_1](./img/section1/rail_1.png)
...
![rail_2](./img/section1/rail_2.png)

### 发射器与投掷器

发射器与投掷器是一种特殊的容器，在接收到信号的时候会将存储的物品随机地投掷出去一次。因此，在需要处理大量物品的时候应当高频率地启动关闭发射器或投掷器。

![dispenser_dropper](./img/section1/dispenser_dropper.png)
...
![high_frequency_circuit_1](./img/section1/high_frequency_circuit_1.png)
...
![high_frequency_circuit_2](./img/section1/high_frequency_circuit_2.png)
...
![high_frequency_circuit_3](./img/section1/high_frequency_circuit_3.png)
