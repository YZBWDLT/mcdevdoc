...
![绳子距离](./img/section2/1_dimension.png)
...
![纸张距离](./img/section2/2_dimension.png)
...
![数轴](./img/section2/number_axis.png)
...
![平面直角坐标系](./img/section2/rectangular_coordinates.png)
...
![空间直角坐标系](./img/section2/space_rectangular_coordinates.png)
...
![启用复制坐标UI](./img/section2/enable_ui.png)
...
![执行tp命令](./img/section2/tp_command.png)

:::

做完上述实验后可以看到，你会被直接传送到这个位置上。

![执行tp命令的效果](./img/section2/tp_command_executed.png)
...
![相对坐标与绝对坐标的混用](./img/section2/relative_world_coordinates_and_absolute_world_coordinates.png)
...
![局部坐标](./img/section2/local_coordinates.png)
