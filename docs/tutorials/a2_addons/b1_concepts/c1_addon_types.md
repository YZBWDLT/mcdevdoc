...
社区中所说的*材质包*，显然也是资源包的范畴，因此*材质包*属于附加包。但是，必须指出的是，*材质包*的说法是长期以来的错传。它们真正的翻译应当叫做**贴图包**或**纹理包（Texture Pack）**。虽然一般玩家并不会在意这些专有名词的区别，但是作为专业人士，我们必须分清这之间的区别。至于为什么不能称之为*材质*，到了第五章，学习了如何自定义一个实体之后，你就会看到这一点。
